  ...
  return (
    <div className="container-fluid p-0">
      ...
      <div className="d-flex flex-nowrap">
        ...
        {/* DESKTOP SIDEBAR */}
        <div
          className="d-none d-md-flex bg-dark text-white vh-100 p-3 flex-column justify-content-between shadow-lg sticky-top flex-shrink-0"
          style={{
            width: "220px",
            zIndex: 1020,
          }}
        >
          <div>
            <h4 className="fw-bold mb-3 text-center text-light">
              Enterprise CRM
            </h4>
          ...
          <div>
            ...
            <button
              className="btn btn-danger w-100 py-2 shadow-sm fw-bold"
              onClick={handleLogout}
            >
              Logout
            </button>
              ...
              <div className="row g-3 mb-4">
                <div className="col-6 col-md-3">
                  <div className="card bg-primary text-white p-3 shadow-sm border-0 h-100 rounded-3">
                    <h6 className="small text-uppercase mb-1 opacity-75">
                      Total Leads
                    </h6>
